            ...
            <?php if (isset($_SESSION['tires']) && isset($tires)):?>
                <?php foreach ($tires as $id => $value):?>
                    <div class="article">
                        ...
                        <div class="price"><div class="wrapper"><input type="number" name="howmuch" value="<?php echo $value['tire_price'] * $_SESSION['tires'][$value['tire_id']];?>" data-value="<?php echo $value['tire_price'];?>" disabled>&#8381;</div><div class="close"><span></span><span class="cl tire" data-id="<?php echo $value['tire_id'] ?>"></span></div></div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
